...
const Widget: React.FC<WidgetProps> = ({ children, onRemove }) => {
  ...
  return (
    <div
      className={`relative flex-grow shadow-xl text-primary select-none flex-shrink basis-1 p-6 w-auto h-full bg-gradient-to-t from-[#f3fcf7] to-[#f3fdf5] font-sans rounded-[45px] ${
